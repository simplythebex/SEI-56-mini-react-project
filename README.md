...
https://simplythebex-news-app.netlify.app/
...
We decided that for our MVP we needed to create three pages:
A landing page to welcome users
An index page to show the headlines
A page that would show further details of a news story

Our aim was to spend the first half of a day understanding our API and working out which data was available to us, then to spend half a day setting up the GET requests and building the basic index and show pages. Finally we would have a day to style and to add extra features.

I built the design in figma, focussing on the design of the index page and choosing to keep it similar on both mobile and desktop:

<img width="748" alt="Screenshot 2021-09-08 at 19 52 23" src="https://user-images.githubusercontent.com/73421779/133090172-b38e9d4c-1b1e-4896-ae30-4d81344bd5dd.png">

We chose to use a mix of Bulma and CSS to style the app, as this allowed us to style efficiently, while giving flexibility to change elements where Bulma’s styling did not fit our design.
...
<img width="622" alt="Screenshot 2021-09-13 at 14 17 06" src="https://user-images.githubusercontent.com/73421779/133090440-47acbdee-3cb3-4a7f-bf34-668a9e403cbe.png">
...
When implementing the save feature my partner and I realised that when the user saves a news article it overwrites the article that is currently in local storage. To fix this I intend to research how to save an array to local storage and to update the array with new additions, rather than overwrite it. 
...
Another win was the use of local storage to use the save feature. I had to research ways to do this and to understand how the local storage works. While the save feature is still a work in progress, I am excited to continue working on this as the feature improves the experience when using the app.
...
## Key Learnings
How to pair-code and communicate while working remotely.
Use of React and particularly React Hooks.
Solidified my CSS skills, and explored CSS frameworks.
